        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <h1 className="font-display mt-4 text-3xl text-stone-900">
              Capture a new item for your archive.
            </h1>
            <p className="mt-3 max-w-2xl text-sm text-stone-600">
              Record the item name, optional notes, and the metadata fields you
            ...
            <div className="mt-6">
              {fieldsState.status === "loading" ? (
                ...
                <ItemForm
                  ...
                  submitPendingLabel="Creating item..."
                  secondaryAction={
          ...
          <aside className="space-y-6">
            <div className="rounded-3xl border border-stone-200 bg-white/80 p-6 shadow-sm">
              ...
              {fieldsState.status === "loading" ? (
                ...
                <div className="mt-4 space-y-3 text-sm text-stone-600">
                  <p>{fieldsState.data.length} fields available.</p>
                  <div className="space-y-2">
                    ...
                    {fieldsState.data.length > 5 ? (
                      <p className="text-xs text-stone-400">
                        +{fieldsState.data.length - 5} more fields
                      </p>
                    ) : null}
                  </div>
            ...
            <div className="rounded-3xl border border-stone-900/90 bg-gradient-to-br from-stone-950 via-stone-900 to-stone-800 p-6 text-stone-100 shadow-sm">
              ...
              <p className="mt-3 text-sm text-stone-300">
                Use the notes field to document acquisition details, restoration
                work, or exhibition history alongside metadata.
              </p>
              <div className="mt-6 flex items-center gap-3 text-xs text-stone-300">
                <ClipboardList className="h-4 w-4 text-amber-300" />
                Metadata fields are validated before saving.
              </div>
            </div>
          </aside>
        </section>
